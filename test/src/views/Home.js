...
const icons = {
  ...
  iconJungle: (
    <g className="e-marker__icon e-marker__icon--jungle">
      <path
...
const Home = () => {
  ...
  return (
    <div className="home">
      <Link
        to="https://vietnam.travel/things-to-do/the-best-ways-to-explore-the-ancient-town-of-hoi-an"
        target="_blank"
      >
        <motion.svg
          whileHover="hovered"
      ...
      L44,66.2C37.7,59.9,30,56.8,23.9,57.6z"
          ...
          <path
            ...
            d="M49.5,62.5l-7.7,7.7h5.8c0,6.4-5.2,11.5-11.5,11.5c-1.9,0-3.8-0.5-5.4-1.3l-2.8,2.8c2.4,1.5,5.2,2.4,8.2,2.4
      ...
      c-2.4-1.5-5.2-2.4-8.2-2.4c-8.5,0-15.4,6.9-15.4,15.4h-5.8l7.7,7.7l7.7-7.7H24.5z"
          ...
          <motion.image
            ...
            height="108.8%"
            clipPath="url(#circle)"
            xlinkHref="https://cdn.riderly.com/storage/media/images/Hero_-_Hoi_An.original.jpg"
          />
          <motion.text
            variants={text}
          ...
          >
            ...
            <tspan x="50%" y="13" style={{ fontSize: 10 }}>
              Ancient town
            </tspan>
          </motion.text>
        </motion.svg>
      </Link>
      <Link to="https://www.rome.info/attractions/colosseum/" target="_blank">
        <motion.svg
          whileHover="hovered"
          initial="default2"
          variants={marker}
      ...
      c-2.4-1.5-5.2-2.4-8.2-2.4c-8.5,0-15.4,6.9-15.4,15.4h-5.8l7.7,7.7l7.7-7.7H24.5z"
          ...
          <motion.image
            ...
            height="105%"
            clipPath="url(#circle)"
            xlinkHref="https://www.costacruises.co.uk/content/dam/costa/costa-magazine/articles-magazine/travel/roma-travel/colosseo-roma_d.jpg.image.1296.974.high.jpg"
          />
          <motion.text
            variants={text}
            className="e-marker__text"
      ...
      <Link to="https://sanblas-islands.com/" target="_blank">
        <motion.svg
          whileHover="hovered"
          initial="default3"
          variants={marker}
      ...
      c-2.4-1.5-5.2-2.4-8.2-2.4c-8.5,0-15.4,6.9-15.4,15.4h-5.8l7.7,7.7l7.7-7.7H24.5z"
          ...
          <motion.image
            ...
            height="100%"
            clipPath="url(#circle)"
            xlinkHref="https://c1.staticflickr.com/5/4241/35467523155_346b08810f_q.jpg"
          />
          <motion.text
            variants={text}
            className="e-marker__text"
